      ...
      <div className='pas'>
        ...
        <div>
          <div className="por">
              ...
              <div className="profile-card">
                ...
                <div className="profile-details">
                  ...
                  <button className='feedb1'>
                    <a className="mail"href ="mailto:gsuryaprakash465@gmail.com">Send email</a>
                  </button>
                  <center>
            ...
            <div class="card11">
              <img src={img30} width={315} height={250} alt="book" className="imag"/>
              <div class="container11">
                ...
                <h6 className='bbb'>₹̶9̶9̶9̶.̶0̶0̶/̶</h6>
                <h6 className='bbb1'>4.8★★★★★</h6>
                ...
                {this.state.displayAdd1 ? (
                  ...
                  <button className='dec' onClick={this.decrementCounter1}>Remove</button>
                )}
              </div>
            </div>
            <div class="card12">
              <div className='ig'></div>
              <img src={img31} width={315} height={250} alt="book" className="imag"/>
              <div class="container12">
                <p className='bio1'>
                  <span style={{ color: "black" }}>Kadence Acoustic Beginners Drum Kit (5 Piece Complete) <br/>
                  Full -Size Drumset with Cymbals
                  </span></p>
                <h6 className='bbb'>₹̶3̶9̶,0̶0̶0̶.0̶0̶/</h6>
                <h6 className='bbb1'>4.9★★★★★</h6>
                ...
                {this.state.displayAdd2 ? (
                  ...
                  <button className='dec1' onClick={this.decrementCounter2}>Remove</button>
                )}  
              </div><br/>
            </div>
